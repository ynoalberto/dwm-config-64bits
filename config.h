...
static const char col_cyan[]        = "#134a25";
...
static const char *roficmd[]  = { "rofi", "-show", "drun",  "-show-icons", "-theme", "Void.rasi", "-xoffset", "9", "-yoffset", "27", NULL };
static const char *rangercmd[]  = { "lxterminal", "-e" , "ranger", NULL };
static const char *bettercmd[]  = { "betterlockscreen", "-l" , "dimblur", NULL };
